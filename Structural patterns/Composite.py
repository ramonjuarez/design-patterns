...
def component_function(self):
	#Print the name of tour child itemn here!
...
class Composite(Component): #Inherits from the abstract class, Component
	...
	def component_function(self):
		...
		#Iterate through the child objects and invoke their component function print
...
#Add the plain submennu 2 to the top-level composite menu
